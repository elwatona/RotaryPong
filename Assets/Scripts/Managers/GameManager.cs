...
namespace RotaryPong
{
    ...
    public class GameManager : SingletonBehaviour<GameManager>
    {
        ...
        {
            Point(ball.BallPaint.Value);

            _announcement.Variable.Value = string.Format("Point for {0}", ball.BallPaint.Value);
            
            UIManager.Instance.Goal(ball.BallPaint.Value);
        ...
        [SerializeField, Header("Parameters")] VariableReference<float> _matchDuration;
        [SerializeField] VariableReference<float> _mapSpinSpeed;
        [SerializeField] VariableReference<float> _celebrationFireworks;
        [SerializeField] VariableReference<float> _camShakeMagnitude;
        [SerializeField] IntVariable _pinkScore;
        [SerializeField] IntVariable _blueScore;
        [SerializeField] VariableReference<bool> _enableGodWalls;
        [SerializeField] VariableReference<bool> _canChangeSpinDirection;
        [SerializeField] VariableReference<string> _announcement;
        [SerializeField] VariableReference<string> _timer;
        [SerializeField] VariableReference<Paint> _ballPaint;
        ...
        public void SetMapRotation(SpinMapInputParameter parameter = default)
        {
            if(!parameter.Equals(default) && !_canChangeSpinDirection.Value && _ballPaint.Value != Paint.White && parameter.SourceTeam != _ballPaint.Value)
            {
