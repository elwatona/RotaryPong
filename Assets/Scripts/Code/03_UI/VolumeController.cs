...
{
    public class VolumeController : BaseField<bool>
    {
        public new class UxmlFactory : UxmlFactory<VolumeController, UxmlTraits> { }
        ...
        // class.
        public VolumeController() : this(null) { }

        // This constructor allows users to set the contents of the label.
        public VolumeController(string label) : base(label, null)
        {
        ...
        {
            var slideToggle = evt.currentTarget as VolumeController;
